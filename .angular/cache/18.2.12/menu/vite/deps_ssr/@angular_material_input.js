...
var SingleBoxSharedResizeObserver = class {
  constructor(_box) {
    ...
    this._resizeSubject = new import_rxjs2.Subject();
  ...
  observe(target) {
    if (!this._elementObservables.has(target)) {
      this._elementObservables.set(target, new import_rxjs2.Observable((observer) => {
        ...
        (0, import_operators2.filter)((entries) => entries.some((entry) => entry.target === target)),
...
var MatFormFieldFloatingLabel = class _MatFormFieldFloatingLabel {
  ...
  constructor(_elementRef) {
    ...
    this._resizeSubscription = new import_rxjs3.Subscription();
  }
  ngOnDestroy() {
    this._resizeSubscription.unsubscribe();
  }
...
var MatFormField = class _MatFormField {
  ...
  _initializeControl() {
    ...
    if (control.ngControl && control.ngControl.valueChanges) {
      control.ngControl.valueChanges.pipe((0, import_operators3.takeUntil)(this._destroyed)).subscribe(() => this._changeDetectorRef.markForCheck());
    }
  }
  ...
  _initializePrefixAndSuffix() {
    ...
    (0, import_rxjs3.merge)(this._prefixChildren.changes, this._suffixChildren.changes).subscribe(() => {
      this._checkPrefixAndSuffixTypes();
      this._changeDetectorRef.markForCheck();
    });
  }
  ...
  _initializeOutlineLabelOffsetSubscriptions() {
    ...
    this._ngZone.runOutsideAngular(() => {
      this._ngZone.onStable.pipe((0, import_operators3.takeUntil)(this._destroyed)).subscribe(() => {
    ...
    this._dir.change.pipe((0, import_operators3.takeUntil)(this._destroyed)).subscribe(() => this._needsOutlineLabelOffsetUpdateOnStable = true);
  }
